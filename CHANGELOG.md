...
| [wazuh-dashboard-plugins#9173](https://github.com/wazuh/wazuh-dashboard-plugins/issues/9173) | Fixed the health check overall status discarding the red result reported by a non critical check                       |
