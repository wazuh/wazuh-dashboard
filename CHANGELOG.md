...
## Wazuh dashboard v10.9.9 - OpenSearch Dashboards 3.6.0 - Revision 00

### Added

- Support for Wazuh 10.9.9

## Wazuh dashboard v5.9.9 - OpenSearch Dashboards 3.6.0 - Revision 00

### Added

- Support for Wazuh 5.9.9
