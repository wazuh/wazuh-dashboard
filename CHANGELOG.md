...
## Wazuh dashboard v4.14.10 - OpenSearch Dashboards 2.19.6 - Revision 00

### Added

- Support for Wazuh 4.14.10

## Wazuh dashboard v4.14.9 - OpenSearch Dashboards 2.19.6 - Revision 00

### Added

- Support for Wazuh 4.14.9

## Wazuh dashboard v4.14.8 - OpenSearch Dashboards 2.19.6 - Revision 01

### Added

- Support for Wazuh 4.14.8

## Wazuh dashboard v4.14.7 - OpenSearch Dashboards 2.19.5 - Revision 01
