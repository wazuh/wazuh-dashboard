# Usage: docker build --build-arg NODE_VERSION=18.19.0 --build-arg WAZUH_DASHBOARDS_BRANCH=4.11.1 --build-arg WAZUH_DASHBOARDS_PLUGINS=4.11.1 --build-arg WAZUH_SECURITY_DASHBOARDS_PLUGIN_BRANCH=4.11.1 --build-arg OPENSEARCH_DASHBOARDS_VERSION=2.16.0 -t wzd:4.11.1 -f wazuh-dashboard.Dockerfile .
...
RUN ./generate_base.sh -v 4.11.1 -r 1 -a file:///home/node/packages/wazuh-package.zip -s file:///home/node/packages/security-package.zip -b file:///home/node/packages/dashboard-package.zip
