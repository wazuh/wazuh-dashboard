...
bash run-docker-compose.sh \
    --app v5.0.0-beta4 \
    --base v5.0.0-beta4 \
    --security v5.0.0-beta4 \
    --securityAnalytics v5.0.0-beta4 \
    --reporting v5.0.0-beta4 \
    --alerting v5.0.0-beta4 \
    --notifications v5.0.0-beta4 \
    --arm \
    --node-version 22.22.0
```

This example will create a packages folder that inside will have the packages divided by repository of the v5.0.0-beta4 git reference of each one.
