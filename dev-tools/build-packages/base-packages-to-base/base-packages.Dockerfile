...
#         --build-arg WAZUH_DASHBOARD_BRANCH=4.99.0 \
#         --build-arg WAZUH_DASHBOARD_SECURITY_BRANCH=4.99.0 \
#         --build-arg WAZUH_DASHBOARD_PLUGINS_BRANCH=4.99.0 \
#         --build-arg ARCHITECTURE=arm \
#         -t wazuh-packages-to-base:4.99.0 \
