...
#         --build-arg WAZUH_DASHBOARD_BRANCH=10.2.3 \
#         --build-arg WAZUH_DASHBOARD_SECURITY_BRANCH=10.2.3 \
#         --build-arg WAZUH_DASHBOARD_PLUGINS_BRANCH=10.2.3 \
#         --build-arg ARCHITECTURE=arm \
#         -t wazuh-packages-to-base:10.2.3 \
