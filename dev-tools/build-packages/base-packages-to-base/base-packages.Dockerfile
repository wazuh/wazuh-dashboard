...
#         --build-arg WAZUH_DASHBOARD_BRANCH=9.99.9 \
#         --build-arg WAZUH_DASHBOARD_SECURITY_BRANCH=9.99.9 \
#         --build-arg WAZUH_DASHBOARD_PLUGINS_BRANCH=9.99.9 \
#         --build-arg ARCHITECTURE=arm \
#         -t wazuh-packages-to-base:9.99.9 \
