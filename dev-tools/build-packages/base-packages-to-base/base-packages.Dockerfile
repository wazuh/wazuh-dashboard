...
#         --build-arg WAZUH_DASHBOARD_BRANCH=4.14.10 \
#         --build-arg WAZUH_DASHBOARD_SECURITY_BRANCH=4.14.10 \
#         --build-arg WAZUH_DASHBOARD_PLUGINS_BRANCH=4.14.10 \
#         --build-arg ARCHITECTURE=arm \
#         -t wazuh-packages-to-base:4.14.10 \
...
ENV OPENSEARCH_DASHBOARDS_VERSION=2.19.6
