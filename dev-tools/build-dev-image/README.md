...
docker build \
  ...
  --build-arg WAZUH_DASHBOARD_REPORTING_BRANCH=migrate-main-to-3.7.0.0 \
  --build-arg WAZUH_DASHBOARD_PLUGINS_BRANCH=migrate-main-to-3.7.0 \
  --build-arg WAZUH_DASHBOARD_SECURITY_ANALYTICS_BRANCH=migrate-main-to-3.7.0.0 \
...
| `--tag`                       | `-t`  | Docker image tag                           | `3.7.0-5.0.0`             |
